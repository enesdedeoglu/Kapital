...
describe('★ zincir kökten dolar — beslenemeyen tesise yatırım yapılmaz (R48)', () => {
   ...
   */
  /*
   * ★ ÖRNEKLEM BÜYÜTÜLDÜ: 6 NPC × 12 tur yalnız ~4 yatırım üretiyordu ve
   * "hiçbir tür yarıdan fazlasını almaz" iddiası o ölçekte gürültüydü — 3/4
   * bile eşiği aşıyor, oysa iddia edilen çöküş (28 yatırımın HEPSİ tek türe)
   * bambaşka bir şey. Fiyat oluşumundaki küçük bir değişiklik göreli kârlılığı
   * bir tık kaydırınca test düşüyordu; sorun kuralda değil ölçümün
   * küçüklüğündeydi.
   */
